...
public class DataVisualizer : MonoBehaviour {
    ...
    List<Color> meshColors)
    {
        ...
        Vector3 pos;
        pos.x = 2.5f * Mathf.Cos((lng) * Mathf.Deg2Rad) * Mathf.Cos(lat * Mathf.Deg2Rad);
        pos.y = 2.5f * Mathf.Sin(lat * Mathf.Deg2Rad);
        pos.z = 2.5f * Mathf.Sin((lng) * Mathf.Deg2Rad) * Mathf.Cos(lat * Mathf.Deg2Rad);
