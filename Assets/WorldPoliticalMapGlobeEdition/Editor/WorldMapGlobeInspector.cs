    ...
    public class WorldMapGlobeInspector : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (expandEarthSection) {
                ...
                if (_map.showEarth) {
                    ...
                    if (_map.earthStyle.isScenic() || _map.earthStyle.isScatter()) {
                        ...
                        if (_map.earthStyle.isScatter()) {
                            ...
                            _map.waveLength = EditorGUILayout.Vector3Field("Wave Length", _map.waveLength);
                        }
                ...
                _map.labelsAntialias = (LABELS_ANTIALIAS)EditorGUILayout.EnumPopup(
    new GUIContent("Overlay Antialias", "Antialias applied to the render texture used to draw labels in blended mode as well as tickers or custom markers."),
    _map.labelsAntialias
    );
            ...
            if (expandGridSection) {
                ...
                _map.latitudeStepping = EditorGUILayout.IntSlider("Stepping", _map.latitudeStepping, 5, 90);
                ...
                if (_map.showHexagonalGrid) {
                    ...
                    _map.gridMaxDistance = EditorGUILayout.FloatField("Visible Distance Max", _map.gridMaxDistance);
            ...
            if (expandCountriesSection) {
                ...
                if (_map.showCountryNames) {
                    ...
                    if (_map.countryLabelsTextEngine == TEXT_ENGINE.TextMeshStandard) {
                        ...
                        _map.countryLabelsFontTMPro = (TMP_FontAsset)EditorGUILayout.ObjectField(new GUIContent("   Font (TMPro)", "Font asset to be used with TextMesh Pro"), _map.countryLabelsFontTMPro, typeof(TMP_FontAsset), false);
                        ...
                        _map.countryLabelsFontTMProMaterial = (Material)EditorGUILayout.ObjectField(new GUIContent("   Font Material (Optional)", "Custmized font material preset to be used in labels"), _map.countryLabelsFontTMProMaterial, typeof(Material), false);
                    }
                    ...
                    _map.countryLabelsOrientation = (COUNTRY_LABELS_ORIENTATION)EditorGUILayout.EnumPopup("Line Orientation", _map.countryLabelsOrientation);
                    EditorGUI.indentLevel--;
                }
            }
            ...
            if (expandInteractionSection) {
                ...
                if (_map.allowUserRotation) {
                    ...
                    _map.constraintPositionEnabled = EditorGUILayout.Toggle(new GUIContent("Constraint Rotation", "Limits the rotation of the globe around a certain point on the globe sphere. This mode is mostly intended for inverted view."), _map.constraintPositionEnabled);
                    ...
                    _map.constraintLatitudeEnabled = EditorGUILayout.Toggle(new GUIContent("Constraint Latitude", "Limits the navigation or rotation beyond the latitude range specified below. This option works best with Keep Straight option and prevents users from going to poles for example."), _map.constraintLatitudeEnabled);
