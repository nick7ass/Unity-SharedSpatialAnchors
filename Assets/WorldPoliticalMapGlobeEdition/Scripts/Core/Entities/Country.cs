...
namespace WPM {
	...
	public partial class Country: AdminEntity {
		...
		TMP_FontAsset _labelFontTMPPro;
		Material _labelFontTMProMaterial;
		...
		/// <summary>
		/// Optional font (TextMesh Pro) for this label. Note that the font material will be instanced so it can change color without affecting other labels.
		/// </summary>
		public TMP_FontAsset labelFontTMProOverride {
			get {
				return _labelFontTMPPro;
			}
			set {
				if (value != _labelFontTMPPro) {
					_labelFontTMPPro = value;
					if (_labelFontTMPPro != null) {
						Material fontMaterial = Object.Instantiate(_labelFontTMPPro.material);
						_labelFontTMPPro.material = fontMaterial;
					}
				}
			}
		}
		...
		/// <summary>
		/// Optional font (TextMesh Pro) material for this label.
		/// </summary>
		public Material labelFontTMProMaterialOverride {
			get {
				return _labelFontTMProMaterial;
			}
			set {
				if (value != _labelFontTMProMaterial) {
					_labelFontTMProMaterial = value;
				}
			}
		}
		...
		public GameObject labelTextGameObject;
		public TextMeshPro labelTextMeshPro;
