...
namespace WPM {
    ...
    public class TileInfo {
        ...
        public void SetAlpha(float t) {
            ...
            switch (subquadIndex) {
                case 0:
                    parent.transMat.SetFloat(ShaderParams.Alpha, t);
                    break;
                case 1:
                    parent.transMat.SetFloat(ShaderParams.Alpha1, t);
                    break;
                case 2:
                    parent.transMat.SetFloat(ShaderParams.Alpha2, t);
                    break;
                case 3:
                    parent.transMat.SetFloat(ShaderParams.Alpha3, t);
                    break;
            }
        }
        ...
        public void SetPlaceholderImage(Texture2D texture) {
            ...
            switch (subquadIndex) {
                case 0:
                    parent.transMat.SetVector(ShaderParams.ParentCoords, parentTextureCoords);
                    break;
                case 1:
                    parent.transMat.SetVector(ShaderParams.ParentCoords1, parentTextureCoords);
                    break;
                case 2:
                    parent.transMat.SetVector(ShaderParams.ParentCoords2, parentTextureCoords);
                    break;
                case 3:
                    parent.transMat.SetVector(ShaderParams.ParentCoords3, parentTextureCoords);
                    break;
            }
        }
